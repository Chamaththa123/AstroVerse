  ...
  return (
    <>
      <animated.section
        ...
        className={` w-full bg-black inset-0 top-0 left-0 bottom-0 z-50  h-[92px]  font-inter flex items-center justify-between p-[15px] xl:py-[10px] xl:px-[40px]`}
      >
        <Link to="/">
      ...
      <UserLogin handleOpen={newHandleOpen} open={newOpen} />
      <UserProfile handleOpen={newProfileHandleOpen} open={newProfileOpen} />
    </>
  );
};
