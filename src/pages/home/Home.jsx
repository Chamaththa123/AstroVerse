...
export const Home = () => {
  ...
  return (
   ...
   <Header/>
    <section
      ref={ref}
      className='overflow-hidden w-full xl:h-screen md:h-[60vh]  bg-black xl:mt-0 mt-[90px] relative flex items-center justify-center font-inter'
    >
    ...
    <section className='xl:hidden block -mt-10'>
      <Footer/>
    </section>
   </>
  )
